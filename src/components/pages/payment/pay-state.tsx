 ...
 <div className='border p-3 rounded-xl'>
                  <div className='flex items-center space-x-2  mt-0 mb-6 '>
                   ...
                   {! connected  ?  (
                    ...
                    <Button  type='submit' className={`w-full capitalize `} disabled={isCheckingOut}>{data?.reciever?.labelText ? `${data?.reciever?.labelText} Now` : isCheckingOut ? "Sending.." : "Continue to pay"}</Button>  
